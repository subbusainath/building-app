...
import FieldCreator from './FieldCreator.jsx'
import './App';
    ...
    render() {
        ...
        <div id="formBuilder">
            <div id="formBuilder-form" className="formBuilderGroup">
                ...
                <FieldCreator deleteField={this.deleteField} addToFormJson={this.addToFormJson}  actualElem={item} definedFields={this.fields} jsonData={item.optionalJson || this.formJson[item.index] || {}} />
                    </div>
                )
                )}
            </div>
